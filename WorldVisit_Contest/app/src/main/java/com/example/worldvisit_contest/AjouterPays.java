...
public class AjouterPays extends Activity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PaysAdapter adapter = new PaysAdapter(AjouterPays.this,R.layout.row,items,AjouterPays.this);
        ...
        filter.addTextChangedListener(new TextWatcher(){
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count){
                ...
                PaysAdapter adapterFilter = new PaysAdapter(AjouterPays.this,R.layout.row,CountryFilter,AjouterPays.this);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder1 = new AlertDialog.Builder(AjouterPays.this);
                builder1.setTitle(lePays.getNomPays());
                builder1.setIcon(AjouterPays.this.getResources().getIdentifier("com.example.geoworld:drawable/" + lePays.getDrapeau(), null, null));
